  ...
  it('should compare two small datasets with noise iterations (bimodal 2)', () => {
    ...
    expect(result).toMatchInlineSnapshot(`
      Object {
        ...
        "effectSize": Object {
          "cohensD": -0.2727188323436056,
          "nonOverlapMeasure": 0.3925346785760198,
          "overlappingCoefficient": 0.8915371551482574,
          "probabilityOfSuperiority": 0.4235416149088691,
        },
  ...
  it('should compare two datasets with noise iterations (similar 3)', () => {
    ...
    expect(result).toMatchInlineSnapshot(`
      Object {
        ...
        "discardedModalities2": Array [],
        "effectSize": Object {
          "cohensD": -0.028877705596218654,
          "nonOverlapMeasure": 0.48848106328115826,
          "overlappingCoefficient": 0.988479862565352,
          "probabilityOfSuperiority": 0.4918543157288896,
        },
