    ...
    expect(result).toMatchInlineSnapshot(`
      Object {
        ...
        "effectSizeStats": Object {
          "changeProbability": 0.04208457559604817,
  ...
  it('should compare two small datasets with noise iterations (similar 1)', () => {
    ...
    expect(result).toMatchInlineSnapshot(`
      Object {
        ...
        "effectSizeStats": Object {
          "changeProbability": -0.0685364593567793,
          "cohensD": -0.10969064504104792,
          "nonOverlapMeasure": 0.44765877429957623,
          "overlappingCoefficient": 0.7907501350853642,
          "probabilityOfSuperiority": 0.46573177032161034,
        },
  ...
  it('should compare two small datasets with noise iterations (similar)', () => {
    ...
    expect(result).toMatchInlineSnapshot(`
      Object {
        ...
        "effectSizeStats": Object {
          "changeProbability": -0.06601552387411974,
          "cohensD": -0.10467166555797736,
          "nonOverlapMeasure": 0.4492609738910154,
          "overlappingCoefficient": 0.7912784289613528,
          "probabilityOfSuperiority": 0.4669922380629401,
        },
  ...
  it('should compare two small datasets with noise iterations (similar - different sample)', () => {
    ...
    expect(result).toMatchInlineSnapshot(`
      Object {
        ...
        "effectSizeStats": Object {
          "changeProbability": -0.19644053448997578,
  ...
  it('should compare two small datasets with noise iterations (bimodal)', () => {
    ...
    expect(result).toMatchInlineSnapshot(`
      Object {
        ...
        "discardedModalities2": Array [],
        "effectSizeStats": Object {
          "changeProbability": -0.22144592440053518,
          "cohensD": -0.3991136009996607,
          "nonOverlapMeasure": 0.34595777748695034,
          "overlappingCoefficient": 0.8421073812164267,
          "probabilityOfSuperiority": 0.38927703779973244,
        },
  ...
  it('should compare two small datasets with noise iterations (bimodal 2)', () => {
    ...
    expect(result).toMatchInlineSnapshot(`
      Object {
        ...
        "effectSizeStats": Object {
          "changeProbability": -0.18858782462391765,
          "cohensD": -0.33972672366421197,
          "nonOverlapMeasure": 0.3687474186625964,
          "overlappingCoefficient": 0.8655687552420215,
          "probabilityOfSuperiority": 0.4057060876880412,
        },
  ...
  it('should compare two small datasets with noise iterations (similar 2)', () => {
    ...
    expect(result).toMatchInlineSnapshot(`
      Object {
        ...
        "effectSizeStats": Object {
          "changeProbability": 0.004345870193199763,
  ...
  it('should compare two datasets with noise iterations (similar 3)', () => {
    ...
    expect(result).toMatchInlineSnapshot(`
      Object {
        ...
        "discardedModalities2": Array [],
        "effectSizeStats": Object {
          "changeProbability": 0.053946140754062705,
          "cohensD": 0.09790222166750293,
          "nonOverlapMeasure": 0.5372627814206293,
          "overlappingCoefficient": 0.935599253066576,
          "probabilityOfSuperiority": 0.5269730703770313,
        },
  ...
  it('should compare two datasets with noise iterations (similar 4)', () => {
    ...
    expect(result).toMatchInlineSnapshot(`
      Object {
        ...
        "effectSizeStats": Object {
          "changeProbability": 0.1038987601125747,
  ...
  it('should compare two small datasets with noise iterations (greater)', () => {
    ...
    expect(result).toMatchInlineSnapshot(`
      Object {
        ...
        "effectSizeStats": Object {
          "changeProbability": -0.3216332906238858,
    ...
    expect(result).toMatchInlineSnapshot(`
      Object {
        "data1": Object {
          ...
          "mean": 93.21546666666667,
          "meanDistanceRatio": 1.0161403989251598,
          "modalityCount": 1,
          "noiseCount": 1,
          "normalityProbability": 0.529708367556621,
          "stdev": 6.490627009846768,
          "variance": 42.12823898095239,
        },
        "data2": Object {
          "data": Array [
            113.622,
          ...
          "mean": 121.822,
          "meanDistanceRatio": 1.0111307240647707,
          "modalityCount": 1,
          "noiseCount": 2,
          "normalityProbability": 0.2523463938222552,
          "stdev": 5.436671266642711,
          "variance": 29.55739446153846,
        },
        "denoiseSettings": Object {
          "bandwidth": 4.201567827326516,
          "kernelStretchFactor": 0.9,
          "shouldSplit1": true,
          "shouldSplit2": true,
          "threshold": 21.457292422293953,
        },
        "effectSizeStats": Object {
          "changeProbability": -0.99666356080577,
          "cohensD": -4.150590218258873,
          "nonOverlapMeasure": 0.000016580951036238023,
          "overlappingCoefficient": 0.03795919246498625,
          "probabilityOfSuperiority": 0.001668219597114995,
        },
        "meanDifference": 28.60653333333333,
        "outcome": "greater",
        "pooledStDev": 6.006297539938528,
        "pooledVariance": 36.07561013827161,
        "stdevDifference": 1.0539557432040567,
        "ttest": Object {
          "degreesOfFreedom": 26.706846267804053,
          "greater": Object {
            "confidenceInterval": Array [
              -32.38600310522957,
              Infinity,
            ],
            "pValue": 0.999999999999723,
            "rejected": false,
          },
          "less": Object {
            "confidenceInterval": Array [
            ...
            "pValue": 2.7700830117066895e-13,
            "rejected": true,
          },
          "tValue": -12.897094212177404,
          "twoSided": Object {
            "confidenceInterval": Array [
              -33.15995588618825,
              -24.05311078047841,
            ],
            "pValue": 5.540166023413379e-13,
            "rejected": true,
          },
        },
      }
  ...
  it('should compare two dataset with varying lengths', () => {
    ...
    expect(result).toMatchInlineSnapshot(`
      Object {
        ...
        "effectSizeStats": Object {
          "changeProbability": -0.13714764273667812,
          "cohensD": -0.24429744625374952,
          "nonOverlapMeasure": 0.40350023058213813,
          "overlappingCoefficient": 0.9027812352719632,
          "probabilityOfSuperiority": 0.43142617863166094,
        },
    ...
    expect(result).toMatchInlineSnapshot(`
      Object {
        ...
        "data2": Object {
          ...
          "discardedCount": 0,
          "discardedData": Array [],
          "mean": 2711.0965950833897,
          "meanDistanceRatio": 1.0210508749266363,
          "modalityCount": 1,
          "noiseCount": 0,
          "normalityProbability": 0.9908418211918213,
          "stdev": 576.8084531082699,
        ...
        "effectSizeStats": Object {
          ...
          "cohensD": -0.2706340110648662,
          "nonOverlapMeasure": 0.39333626730768817,
          "overlappingCoefficient": 0.8923612402682358,
          "probabilityOfSuperiority": 0.424118979639743,
        },
        "meanDifference": 181.50716617927583,
        "outcome": "similar",
        "outcomeFrequencies": Object {
          "less": 0.2631578947368421,
          "similar": 0.7368421052631579,
        },
        "pooledStDev": 640.7047928765717,
        "pooledVariance": 410502.6316150107,
        "stdevDifference": 121.97425392794901,
        "ttest": Object {
          "degreesOfFreedom": 75.29580358530849,
          "greater": Object {
            "confidenceInterval": Array [
              -420.09418698105486,
              Infinity,
            ],
            "pValue": 0.8954564866986106,
            "rejected": false,
          },
          "less": Object {
            "confidenceInterval": Array [
            ...
            "pValue": 0.1045435133013894,
            "rejected": false,
          },
          "tValue": -1.2669246944696966,
          "twoSided": Object {
            "confidenceInterval": Array [
              -466.8891914408232,
              103.87485908227247,
            ],
            "pValue": 0.2090870266027788,
            "rejected": false,
          },
        },
        "ttestAdjusted": Object {
          ...
          "less": Object {
            "pValue": 0.06602748208508805,
            "rejected": false,
          },
          "twoSided": Object {
            "pValue": 0.3131545231024131,
            "rejected": false,
          },
        },
      }
